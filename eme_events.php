...
<table class="form-table">
   ...
   eme_options_radio_binary ( __ ( 'Use the client browser clock for the calendar', 'eme' ), 'eme_use_client_clock', __ ( 'Check this option if you want to use the clock of the client as base to calculate current day for the calendar.', 'eme' ) );
