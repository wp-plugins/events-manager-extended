...
<table class="form-table">
   ...
   eme_options_textarea ( __ ( 'Default location balloon format', 'eme' ), 'eme_location_baloon_format', __ ( 'The format of the text appearing in the balloon describing the location in the map.<br/>Insert one or more of the following placeholders: <code>#_NAME</code>, <code>#_ADDRESS</code>, <code>#_TOWN</code>, <code>#_DESCRIPTION</code> or <code>#_IMAGE</code>.', 'eme' )." " . __('You can also use <code>#_DIRECTIONS</code> to insert a direction form in the balloon, but then you should add at least 4 extra &lt;br/&gt;-tags after it, otherwise the balloon will not be of the correct height.','eme') );
