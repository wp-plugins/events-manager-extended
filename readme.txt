...
* Feature: new shortcode [event_locations], giving you a list of all locations, when used in combo with the calendar it can be used to show only specific events in the calendar
