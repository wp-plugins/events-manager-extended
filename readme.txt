...
* Feature: new shortcode [events_filterform], creates a form with dropdowns for categories, locations and/or towns (configurable in the settings). To be used on the same page as [events_list], otherwise it has no effect.
