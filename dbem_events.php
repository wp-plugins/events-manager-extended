...
<table class='form-table'>
	...
	dbem_options_radio_binary ( __ ( 'Use captcha for booking form?', 'dbem' ), 'dbem_captcha_for_booking', __ ( 'Check this option if you want to use a captcha on the booking form, to thwart spammers a bit.', 'dbem' ) );
