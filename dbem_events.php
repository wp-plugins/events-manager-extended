...
<table class='form-table'>
	...
	dbem_options_radio_binary ( __ ( 'Require WP membership to be able to register?', 'dbem' ), 'dbem_rsvp_registered_users_only', __ ( 'Check this option if you want that only WP registered users can book for an event.', 'dbem' ) );
